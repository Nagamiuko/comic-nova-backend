...
//   res.json({ status: "ok" });
// });
router.get("/users", middleware_1.AuthenticationMiddleware, user_controller_1.getUsers);
router.get("/user", middleware_1.AuthenticationMiddleware, user_controller_1.getUser);
